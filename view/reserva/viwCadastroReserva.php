  ...
  <form id="frmCadastroReserva" style="height: 100%;">
    <table width="100%" cellspacing="2" cellpadding="0" role="presentation">
      <tr>
        ...
        <td>
          <input type="text" id="idReserva" name="idReserva" tabindex="-1" class="k-textbox k-input-disabled" readonly="readonly" style="width: 80px;" value="<?php echo $objTbReserva->Get("idreserva") ?>">
        </td>
      </tr>
    </table>
     <table width="100%" cellspacing="2" cellpadding="0" role="presentation">
      <tr>
        <td class="k-required" style="text-align: right; width: 120px;">Sala:</td>
        <td>
      ...
      <tr>
        ...
        <td>
          ...
          <span id="BtnColaborador" style="cursor: pointer; width: 24px; height: 24px;" title="consultarColaboradores"></span>
           <input type="text" id="nmColaborador" name="nmColaborador" tabindex="2" class="k-textbox" style="width: 511px;" value="<?php echo $objTbReserva->GetObjColaborador()->Get("nmcolaboradorsala") ?>">
        </td>
      </tr>
    </table>
    <table width="100%" cellspacing="2" cellpadding="0" role="presentation">
      <tr>
        ...
        <td>
          <input type="text" id="dtData" name="dtData" tabindex="3" style="width: 100px;" value="<?php echo $objTbReserva->Get("dtdata") ?>">
        </td>
      </tr>
    </table>
     <table width="100%" cellspacing="2" cellpadding="0" role="presentation">
      <tr>
        ...
        <td>
          <input type="text" id="hrInicio" name="hrInicio" tabindex="4" style="width: 100px;" value="<?php echo $objTbReserva->Get("hrinicio") ?>">
        </td>
        <td class="k-required" style="text-align: right; width: 334px;">Hora Fim:</td>
        <td>
          <input type="text" id="hrFim" name="hrFim" tabindex="5" style="width: 100px;" value="<?php echo $objTbReserva->Get("hrfim") ?>">
        </td>
      </tr>
    </table>
